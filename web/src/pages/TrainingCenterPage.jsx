...
const TrainingCenterPage = () => {
  ...
  return (
    <>
      <Helmet><title>{t('nav.training')} - HGW</title></Helmet>
        ...
        <div className="flex">
          ...
          <main className="flex-1 ml-4 lg:ml-80 mr-4 mt-8 mb-8 transition-all duration-300">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto space-y-8">
              <h1 className="text-4xl font-bold mb-8 gradient-text">{t('nav.training')}</h1>
              <Card className="glass-card premium-shadow">
                <CardHeader><CardTitle>Getting Started</CardTitle></CardHeader>
                <CardContent><p className="text-muted-foreground">Fundamentals of HGW</p></CardContent>
              </Card>
            </motion.div>
          </main>
        </div>
